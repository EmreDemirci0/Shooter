...
namespace Akila.FPSFramework
{
    ...
    public class CharacterManager : MonoBehaviour
    {
        ...
        {
            if (characterController) return characterController.velocity.magnitude <= 0.5f;
            if (!characterController && attachedRigidbody) return attachedRigidbody.velocity.magnitude <= 0.5f;
