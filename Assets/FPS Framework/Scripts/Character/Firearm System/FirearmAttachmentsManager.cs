...
namespace Akila.FPSFramework
{
    ...
    public class FirearmAttachmentsManager : MonoBehaviour
    {
        ...
        protected void Start()
        {
            ...
            if (targetFirearm == null && pickable == null)
            {
                Debug.LogError("FirearmAttachmentsManager: No Firearm or Pickable component found on the GameObject.", gameObject);
            }
        }
        ...
        public void UpdateCameraFOV(float mainCameraFOV, float overlayCameraFOV, float t)
        {
            ...
            {
                cameraManager.SetFieldOfView(mainCameraFOV, overlayCameraFOV, t);
            }
            else
            {
        ...
        public void SwitchAttachment(string typeAndName)//Sight/Red Dot 1
        {
            ...
            if (firearm.inventory.items[firearm.inventory.currentItemIndex] != firearm) return;
